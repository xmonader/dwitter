...
import XmonaderDwitterXmonaderDwitterDwitter from './xmonader/dwitter/xmonader.dwitter.dwitter';
export default {
    ...
    XmonaderDwitterXmonaderDwitterDwitter: load(XmonaderDwitterXmonaderDwitterDwitter, 'xmonader.dwitter.dwitter'),
};
